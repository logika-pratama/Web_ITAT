                                ...
                                <div class="container-fluid">
                                    <div class="page-title-box">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-4">
                                                <a href="javascript:void(0)" onclick="changePageMain()" data-url="<?=base_url('index.php/cek_aset')?>" class="btn btn-secondary btn-sm mb-2" style="height:85px; width:100%;">
                                                    <i class="bx bx-notepad bx-md mb-1"></i>
                                                    <p class="icon-name text-capitalize">Cek Aset (QR Code)</p>
                                                </a>
                                            </div>
                                        </div> <!-- end row -->
                                    </div>
