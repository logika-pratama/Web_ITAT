                                ...
                                <div class="container-fluid">
                                    <div class="page-title-box">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-4">
                                                <a href="javascript:void(0)" onclick="changePageMain()" data-url="<?=base_url('index.php/ujimat_flash')?>" class="btn btn-danger btn-sm mb-2" style="height:107px; width:100%;"  class="btn btn-primary btn-sm mb-2" style="height:85px; width:100%;">
                                                    <i class="bx bx-package bx-sm mb-1 mt-2"></i>
