                                ...
                                <div class="container-fluid">
                                    <div class="page-title-box">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-4">
                                                <a href="<?=base_url('index.php/searching/waiting?url=')?>https://10.230.200.157/itat/index.php/ujimat'"  class="btn btn-primary btn-sm mb-2" style="height:85px; width:100%;">
