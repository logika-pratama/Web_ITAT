<div class="row mt-2">
    ...
    <div class="col-md-12 text-center mb-3">
        ...
        <h5 class="qrcode1"></h5>
        <input name="ble1" class="qrcode1" type="hidden">
    </div>
    <div class="col-md-12 text-center mb-3">
        <button onclick="showData(2)" class="btn btn-primary btn-xl">Pindai Qrcode TAG BLE</button>
        <h5 class="qrcode2"></h5>
        <input name="ble2" class="qrcode2" type="hidden">
    </div>
    <div class="col-md-12 text-center mb-3">
